...
import { selectCurrentMessage, setShow, setMessage, setCurrentTaoModelId, setCurrentTaoModelName, setCurrentExportId, setCurrentTab, setCurrentProjectAspect } from '../redux/store/slice/currentMessage';
...
const Utility = forwardRef((props, ref) => {
    ...
    const currentProjectAspect = useSelector(selectCurrentMessage).currentProjectAspect;
    ...
    useImperativeHandle(ref, () => ({
        ...
        setCurrentProjectAspect: (myProjectAspect) => {
            dispatch(setCurrentProjectAspect(myProjectAspect));
        },
        getCurrentProjectAspect: () => {
            return currentProjectAspect;
        },
