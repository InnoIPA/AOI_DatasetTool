...
export const currentMessage = createSlice({
    ...
    reducers: {
        ...
        setCurrentProjectAspect: (state, action) => {
            state.currentProjectAspect = action.payload;   
        },
    },
});

export const selectCurrentMessage = (state: { currentMessage: { message: string ,show:boolean, currentTaoModelId:string,currentTaoEvaluateId:string,currentTaoInferenceId:string,currentTaoExportId:string,currentProjectAspect:boolean} }) => state.currentMessage;

export const { setMessage,setShow,setCurrentTaoModelId,setCurrentTaoModelName,setCurrentExportId,setCurrentTab,setCurrentTaoEvaluateId,setCurrentTaoInferenceId,setCurrentTaoExportId,setCurrentProjectAspect } = currentMessage.actions;  // 輸出action
