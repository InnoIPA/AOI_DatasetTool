...
import { datasetToolProjectAPI_A } from './APIPath';
...
import InferenceResultPageAspect from './page/InferenceResultPageAspect';
...
import SetAttributePageAspect from './page/setAttributePageAspect';
        ...
        <Provider store={store}>
            <div className="app-container">
                ...
                <div className="page-container">
                    ...
                    {pageKey === 'SetAttributePageAspect' && <SetAttributePageAspect {...{ setPageKey, currentProject, fetchProject }} />}
                    ...
                    {pageKey === 'InferenceResultPageAspect' && <InferenceResultPageAspect {...{ setPageKey, setCurrentProject, projectData }} />}
