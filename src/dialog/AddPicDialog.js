...
const AddPicDialog = forwardRef((props, ref) => {
    ...
    const handleFetchPic = async () => {
        ...
        try {
            ...
            console.log('--- fetch data url ---', `${dsImageInsertAPI}?machine_ip=${myMachineIp}&image_id=${myImageId}`);
            ...
            console.log('data:image/jpg;base64,' + resJson.cropimage);
    ...
    const handleInsertPic = async () => {
        ...
        //return;
        console.log('--- insert image url ---', `${dsImageInsertAPI}`);
