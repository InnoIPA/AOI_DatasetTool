...
import { theme2 } from '../page/ProjectPage';
...
const RatioAspectDialog = (props: RatioDialogProps) => {
  const {
    openRatioDialog,
    setOpenRatioDialog,
    trainPass,
          ...
          <form onSubmit={() => { }}>
            <div className="dialog-content">
              ...
              <div className="lower-right-button-container">
                ...
                <CustomButton name='view-aspect' text='OK' width={100} onClick={(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
                  adjustRatio(e);
                  setOpenRatioDialog(false);
                }}></CustomButton>
              </div>
...
export default RatioAspectDialog;
