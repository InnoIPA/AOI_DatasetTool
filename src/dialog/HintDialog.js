                ...
                <Modal open={show}>
                    <ModalDialog style={{ width: 800, height: 600, borderRadius: 12 }} layout='center'>
                        <div className='d-flex align-items-start flex-column bd-highlight mb-0' style={{ height: 600 }}>
                            ...
                            <ol className="col-12 list-group list-group mt-3 my-list">
                                <li className="list-group-item d-flex justify-content-between align-items-start gap-1">
                                    <div className={`my-number-tag${aspect ? '-aspect' : ''}`}>1</div>
                                    <div className="ms-2 me-auto">
                                        <div className={`fw-bold ${aspect ? 'my-blue-color' : 'my-red-color'}`}>Show full size image on new tab</div>
                                        Press alt (or option) key and click the image.
                                    </div>

                                </li>
                                <li className="list-group-item d-flex justify-content-between align-items-start gap-1">
                                    <div className={`my-number-tag${aspect ? '-aspect' : ''}`}>2</div>
                                    <div className="ms-2 me-auto">
                                        <div className={`fw-bold ${aspect ? 'my-blue-color' : 'my-red-color'}`}>Quick view image on same page</div>
                                        Mouse over the image and click key space.
                                    </div>

                                </li>
                                <li className="list-group-item d-flex justify-content-between align-items-start gap-1">
                                    <div className={`my-number-tag${aspect ? '-aspect' : ''}`}>3</div>
                                    <div className="ms-2 me-auto">
                                        <div className={`fw-bold ${aspect ? 'my-blue-color' : 'my-red-color'}`}>Select all or unselect all block data items</div>
                                        Mouse over the block and double click.
                                    </div>

                                </li>
                                <li className="list-group-item d-flex justify-content-between align-items-start gap-1">
                                    <div className={`my-number-tag${aspect ? '-aspect' : ''}`}>4</div>
                                    <div className="ms-2 me-auto">
                                        <div className={`fw-bold ${aspect ? 'my-blue-color' : 'my-red-color'}`}>Select continuity items</div>
                                        Mouse click the first item, and then press key shift and mouse click the last one.
                                    </div>

                                </li>
                                <li className="list-group-item d-flex justify-content-between align-items-start gap-1">
                                    <div className={`my-number-tag${aspect ? '-aspect' : ''}`}>5</div>
                                    <div className="ms-2 me-auto">
                                        <div className={`fw-bold ${aspect ? 'my-blue-color' : 'my-red-color'}`}>Move selected items between blocks</div>
