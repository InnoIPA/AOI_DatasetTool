...
const ResultTableList = (props) => {
    ...
    const tableColumnWidth = [50, 180, 180, 140, 140, 150, 150, 140, 140, 100];
        ...
        <ThemeProvider theme={theme}>
            ...
            <div className='my-table'>
                <div className={(true) ? 'my-thead' : 'my-thead-shadow'} style={{ backgroundColor: "#FAFAFD" }}>
                    ...
                    <div className='my-thead-th' style={{ width: tableColumnWidth[1] }}>Comp. Name</div>
                    ...
                    <div className='my-thead-th' style={{ width: tableColumnWidth[6] }}>Threshold</div>
                    <div className='my-thead-th' style={{ width: tableColumnWidth[7] }}>Label</div>
                    <div className='my-thead-th' style={{ width: tableColumnWidth[8] }}>Result</div>
                    <div className='my-thead-th' style={{ width: tableColumnWidth[9] }}></div>
                ...
                <div className='my-tbody' style={{ height: 650 }}>
                    {
                        props.data.map((item, index) => (
                            <div className={`my-tbody-row-${(index % 2 === 1) ? "1" : "2"}`} key={`${item.imageUuid}_${index}`}>
                                ...
                                <div className='my-tbody-td' style={{ width: tableColumnWidth[9] }} >
