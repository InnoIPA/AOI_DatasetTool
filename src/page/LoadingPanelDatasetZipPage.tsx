          ...
          <div className="loading-container">
            {isFinish ? (
              <div >
                ...
                <CustomButton
                  name={(currentProject.project_high_aspect)?"download-button-with-icon-aspect":"download-button-with-icon"}
                  width={500}
                  height={100}
                  text={`Download zip file of ${currentProject.project_name}`}
                  className={(currentProject.project_high_aspect) ? "icon-button-style-aspect" : "icon-button-style"}
