...
import { theme,theme2 } from './ProjectPage';
...
const ChooseProductPage = (props: ChooseProductPageProps) => {
    ...
    return (
        <>
            <ThemeProvider theme={(currentProject.project_high_aspect)?theme2:theme}>
                                ...
                                <div>
                                    {
                                        ...
                                        (currentType === '0') ?
                                            <div className='d-flex flex-column mb-2'>
                                                ...
                                                <div>
                                                    <CustomButton name={(currentProject.project_high_aspect)?"view-aspect":"view"} text="Query" width={100} height={36} onClick={() => searchByName()}></CustomButton>
                                                </div>
                                            </div>
                                            :
                                            <div></div>
                                                    ...
                                                    pathListSearch.map((data, idx) => {
                                                        ...
                                                        return (
                                                            <div key={idx} className={`my-row-${(idx % 2 === 1) ? "1" : "2"}`}>
                                                                <label
                                                                    className={`${(currentProject.project_high_aspect)?"my-checkbox-aspect":"my-checkbox"} my-dataSource-item ${selectedPathList.findIndex((item) => item === data.date + '/' + data.station + '/' + data.model) > -1 && 'dataSource-item-selected'
                                                                        }`}
                                                                >
                                                ...
                                                <div key={path} className={`selected-path-${(index % 2 === 1) ? "1" : "2"}`}>
                                                    <div style={{ width: '10%' }} className='my-table-td'>
                                                        <span className="delete-button" onClick={() => handleDelete(index)}>
                                                            <FontAwesomeIcon icon={faTrashCan} className="icon-button" color={(currentProject.project_high_aspect)?"#0e86d4":"#ed1b23"} />
                                                        </span>
                                                    </div>
                                                    <div style={{ width: '20%' }} className='my-table-td'>
            ...
            <ProgressDialog
                ...
                projectAspect={currentProject.project_high_aspect}
            />
